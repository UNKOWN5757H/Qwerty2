...
from plugins.short import short2, short3, short4
from plugins.premium import premcall  
...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    elif re.match("^premium$", data):
        await premcall(client, query)
    
    elif re.match("^short_(web|api)$", data):
        await short2(client, query)
    
    elif re.match("^short_rem$", data):
        await short3(client, query)
    
    elif re.match("^mode_(24|link)$", data):
